  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx((){
        ...
        //   case Status.ERROR:
        //     if(seekerOutgoingRequestSinglePageController.error.value =='No internet'){
        ...
        //   case Status.COMPLETED:
            ...
            final  myUserUrl=  seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.getseeker!.id.toString()==myId? seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.getanotherseeker!:seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.getseeker!;
            final requestStatus;
            (seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.matchWith==myId)?
            requestStatus=seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.matchWithStatus:
            requestStatus=seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.matchFromStatus;
            return Column(
                children: [
                  SizedBox(
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            width: Get.width * 0.9,
                            decoration:
                            BoxDecoration(color: Color.fromRGBO(245, 244, 244, 1)),
                            child: Row(
                              children: [
                                Container(
                                ...
                                Container(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.getmaker!.imgPath.toString(),
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.getmaker!.name.toString(),
                                      style: TextStyle(
                                        color: Colors.black,
                                    ...
                                    Text(
                                      seekerOutgoingRequestSinglePageController.ViewProfileDetail.value.data!.getmaker!.aboutMaker.toString(),
                                      style: TextStyle(
                                          color: Colors.black,
...
// *******************
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                (myUserUrl.details!.interestName!=null )? Row(children: [
                                  for (var i = 0; myUserUrl.details!.interestName!.length > i; i++)
                                    Text(
                                      myUserUrl.details!.interestName![i].title.toString()+" ",
                                      style: TextStyle(
                                          fontSize: 6,
                                          color: Colors.black,
                                          fontWeight:
                            ...
                            Row(
                              children: [
                                ...
                                (myUserUrl. religion==null || myUserUrl. religion=='')?Container():Container(
                                    height: Get.height * 0.03,
                                    width: Get.width * 0.19,
                                    decoration: BoxDecoration(
                                      color: Color.fromRGBO(
                                ...
                                (myUserUrl. height==null || myUserUrl. height=='')?Container():Container(
                                    height: Get.height * 0.03,
                                    width: Get.width * 0.19,
                                    decoration: BoxDecoration(
                                      color: Color.fromRGBO(
                            ...
                            Row(
                              children: [
                                ...
                                (myUserUrl. salary==null || myUserUrl. salary=='')?Container(
                                  child: SizedBox(width: Get.width*0.18,),
                                ): Container(
                                    height: Get.height * 0.03,
                                    width: Get.width * 0.19,
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        // SizedBox(width: Get.width*0.002,),
                                        Text(
                                          myUserUrl.salary.toString()+' Monthly',
                                          style: TextStyle(
                                              fontSize: 6,
                                              fontWeight:
                                              FontWeight.w400),
                  ...
                  (requestStatus=='accepted')?Row(children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: Colors.white,
                              border: Border.all(
                                  color: Color.fromRGBO(0, 12, 170, 1), width: 1),
                              borderRadius: BorderRadius.circular(60)),
                          child: Center(
                            child: Text('Declined',
                                style: TextStyle(
