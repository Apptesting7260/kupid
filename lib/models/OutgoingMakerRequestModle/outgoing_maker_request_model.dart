...
//
//     final outgoingMakerRequestModel = outgoingMakerRequestModelFromJson(jsonString);

import 'dart:convert';

OutgoingMakerRequestModel outgoingMakerRequestModelFromJson(String str) => OutgoingMakerRequestModel.fromJson(json.decode(str));

String outgoingMakerRequestModelToJson(OutgoingMakerRequestModel data) => json.encode(data.toJson());

class OutgoingMakerRequestModel {
  String? status;
  List<Request>? requests;

  OutgoingMakerRequestModel({
     this.status,
     this.requests,
  });

  factory OutgoingMakerRequestModel.fromJson(Map<String, dynamic> json) => OutgoingMakerRequestModel(
    status: json["status"],
